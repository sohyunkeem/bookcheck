		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "booking",
									"targetURL": "#syncc201bookcheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc201bookcheck-display": {
								"semanticObject": "syncc201bookcheck",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c201.bookcheck",
									"url": sap.ui.require.toUrl("sync/c201/bookcheck")
								}
							}
						}
					}
